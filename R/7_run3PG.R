...
lat_full <- read.csv("D:/BP_Layers/outputs/crops/lat/044.csv")
inputs_full <- read.csv("D:/BP_Layers/outputs/crops/inputs/044.csv")
...
climate_df <- read.csv("D:/BP_Layers/outputs/crops/climate/044.csv") %>% na.omit()
inputs_df <- read.csv("D:/BP_Layers/outputs/crops/inputs/044.csv") %>% na.omit()
rad_df <- read.csv("D:/BP_Layers/outputs/crops/rad/044.csv") %>% na.omit()
