...
#output folder
out.dir <- ("D:/BP_Layers/U_18S/3PG_flt/1_clipped_rad/")
...
test1 <- rast("D:/BP_Layers/U_18S/3PG_flt/1_clipped_rad/Rad12.tif")
...
terra::writeRaster(tree.age.proj, "D:/BP_Layers/U_18S/inputs/Forest_Age_2019_U_18S.tif", overwrite = T)

# We want to make sure tree age is aligned for relevant study areas
#tree.age <- rast("D:/BP_Layers/U_18S/inputs/Forest_Age_2019_U_18S.tif")

tree.age <- rast("D:/BP_Layers/U_18S/3PG_flt/4_30m_inputs_all/Forest_Age_2019_withNA.tif")
...
out.dir = "D:/BP_Layers/U_18S/3PG_flt/4_30m_inputs_all/"
...
#folder with data
fp <- paste0("D:/climate/U_18S/output_tif_30m/", scen)
#list of files in folder
tiffs <- list.files(fp, pattern = ".tif$", full.names = TRUE, recursive = TRUE)

#output folder
output_folder <- paste0("D:/BP_Layers/U_18S/3PG_flt/3_frost/", scen) # check we have a /
...
fp = "D:/BP_Layers/U_18S/3PG_flt/1_clipped_rad"
...
# check alignment ...
check.rast1 <- rast("D:/BP_Layers/U_18S/3PG_flt/2_normalized_rad/Rad02.tif")
...
fp = "D:/BP_Layers/U_18S/3PG_flt/4_30m_inputs_all"

tiffs = list.files(fp, pattern = ".tif$", full.names = T, recursive = T)

# Create a new folder to save the processed rasters
output_folder <- "D:/BP_Layers/U_18S/3PG_flt/5_90m_inputs_all/"
dir.create(output_folder, showWarnings = FALSE)
...
input_dir <- "D:/BP_Layers/U_18S/3PG_flt/5_90m_inputs_all"

output_dir <- "D:/BP_Layers/U_18S/3PG_flt/6_90m_flt"
...
check.rast3 <- rast("D:/BP_Layers/U_18S/3PG_flt/5_90m_inputs_all/PPT09.tif")
...
directory <- "D:/BP_Layers/U_18S/3PG_flt/6_90m_flt"
...
for (hdr_file in hdr_files) {
  ...
  new_content <- c(
    ...
    "xllcenter         418500", # 90m =  325620 , 30m =
    "yllcenter         5870100", # 90m = 5236920 , 30m =
...
#check.rast4 <- rast("D:/BP_Layers/U_18S/3PG_flt/2_climate_align/NFFD05.tif")
