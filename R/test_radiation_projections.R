...
file.name = "Forest_Age_2019_withNA"
## check geometry
...
fp <- "D:/BP_Layers/M_9S/3PG_flt/2_future_climate_align/Y2_S2/"
tiffs <- list.files(fp, pattern = ".tif$", full.names = TRUE, recursive = TRUE)

# Create a new folder to save the processed rasters
output_folder <- "D:/BP_Layers/M_9S/3PG_flt/3_future_frost/Y2_S2"
...
#####
# aggregate
fp = "D:/BP_Layers/M_9S/3PG_flt/3_future_frost/ssp370/"

tiffs = list.files(fp, pattern = ".tif$", full.names = T, recursive = T)

# Create a new folder to save the processed rasters
output_folder <- "D:/BP_Layers/M_9S/3PG_flt/5_90m_inputs_future/ssp370/"
dir.create(output_folder, showWarnings = FALSE)

for(t in tiffs){
  out.path = str_replace(t, "3_future_frost", "5_90m_inputs_future")
...
###
# Compare geom
check.rast <- rast("D:/BP_Layers/M_9S/3PG_flt/5_90m_inputs_future/ssp245/NFFD01.tif")
...
input_dir <- "D:/BP_Layers/M_9S/3PG_flt/5_90m_inputs_future/ssp370"

output_dir <- "D:/BP_Layers/M_9S/3PG_flt/6_90m_flt_future/ssp370"
...
directory <- "D:/BP_Layers/M_9S/3PG_flt/6_90m_flt_future/ssp370"
