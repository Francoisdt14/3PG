...
tree.age <- rast("D:/BP_Layers/M_11S/3PG_flt/4_30m_inputs_all/Forest_Age_2019_withNA.tif")
...
fp = "D:/BP_Layers/M_11S/3PG_flt/2_climate_align"
...
for(t in tiffs){
  out.path = str_replace(t, "2_climate_align", "5_90m_inputs_all")
...
check.rast3 <- rast("D:/BP_Layers/M_11S/3PG_flt/5_90m_inputs_all/tmin01.tif")
...
check.rast4 <- rast("D:/BP_Layers/U_15S/3PG_flt/6_90m_flt/tmax05.flt")
